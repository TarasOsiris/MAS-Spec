...
s.source = { :http => 'https://mas-artifacts.yodo1.com/4.3.2/iOS/Release/Yodo1MasFull-4.3.2.zip' }
...
s.dependency 'Yodo1MasCore', '4.3.2'
s.dependency 'Yodo1MasMediationAdMobMax', '4.3.2'
s.dependency 'Yodo1MasMediationApplovinMax', '4.3.2'
s.dependency 'Yodo1MasMediationFyberMax', '4.3.2'
s.dependency 'Yodo1MasMediationIronSourceMax', '4.3.2'

s.dependency 'Yodo1MasMediationAdColonyMax', '4.3.2'
s.dependency 'Yodo1MasMediationFacebookMax', '4.3.2'
s.dependency 'Yodo1MasMediationInMobiMax', '4.3.2'
#s.dependency 'Yodo1MasMediationMintegralMax', '4.3.2'
s.dependency 'Yodo1MasMediationMyTargetMax', '4.3.2'
s.dependency 'Yodo1MasMediationPangleMax', '4.3.2'
s.dependency 'Yodo1MasMediationTapjoyMax', '4.3.2'
